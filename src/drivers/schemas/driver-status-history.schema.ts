...
export type DriverStatusHistoryDocument = HydratedDocument<DriverStatusHistory>;
...
export const DriverStatusHistorySchema = SchemaFactory.createForClass(DriverStatusHistory);